...
import com.shatteredpixel.shatteredpixeldungeon.actors.mobs.npcs.OldCrowInnkeeper;
...
public class OldCrowInnLevel extends Level {
    ...
    @Override protected void createMobs(){
        OldCrowInnkeeper innkeeper = new OldCrowInnkeeper();
        innkeeper.pos = cell(18,9);
        mobs.add(innkeeper);
