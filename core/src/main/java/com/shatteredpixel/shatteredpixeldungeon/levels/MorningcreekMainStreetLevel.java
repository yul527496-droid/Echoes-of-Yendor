...
public class MorningcreekMainStreetLevel extends Level {
    ...
    protected boolean build(){
        ...
        // broad cobbled spine and central square
        ...
        // Old Crow Inn closes the north end of the street and anchors navigation.
    ...
    private void installVisualFoundation(){
        ...
        // south-to-north landmark cadence: gate -> shops -> well -> inn.
    ...
    public boolean activateTransition(Hero hero,LevelTransition transition){
        if(transition.type==LevelTransition.Type.REGULAR_ENTRANCE){ SequelGame.enterOutskirtsFromTown(); return true; }
        if(transition.type==LevelTransition.Type.REGULAR_EXIT){ SequelGame.enterOldCrowInn(); return true; }
